...
const LandingPage = () => {
  return (
    <>
      <div className="relative w-full hero-gradient-bg overflow-x-hidden min-h-screen flex flex-col">
        {/* Content */}
        <div className="relative z-10 flex flex-col items-center justify-center min-h-[80vh] px-4 sm:px-6 md:px-8">
          <div className="text-center max-w-3xl w-full">
            <h1 className="text-3xl sm:text-4xl md:text-5xl lg:text-6xl font-bold mb-4 sm:mb-5 md:mb-6 leading-tight">
              ...
              Starts at <span className="text-gradient">MetaMusk.AI</span>
            </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-3 sm:gap-4 justify-center items-center">
              <Link
                to="/debug"
                className="btn btn-lg btn-wide card-gradient relative overflow-hidden text-white text-lg px-10"
              >
                Get Started
              </Link>
            </div>
