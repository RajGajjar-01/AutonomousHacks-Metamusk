        ...
        <nav className="navbar bg-base-100/80 backdrop-blur-md border-b border-base-content/10 sticky top-0 z-50 px-4 lg:px-6 transition-all duration-300">
            <div className="navbar-start">
                ...
                <div className="dropdown lg:hidden">
                    ...
                    <ul tabIndex={0} className={`menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow-lg bg-base-100/95 backdrop-blur rounded-box w-52 border border-base-content/10 ${isMenuOpen ? 'block' : 'hidden'}`}>
                        {navLinks.map((link) => (
                            <li key={link.path}>
                                <Link
                                    to={link.path}
